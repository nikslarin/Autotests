...
import demo_new.pages.BasePage;
import demo_new.pages.TransferPage;
import demo_new.pages.TransferResult;
...
public class ScenarioSteps {
    ...
    public void fillField(String name, String value) throws Exception {
        Class example = Class.forName("demo_new.pages." + currentPageName);
